(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('blockies'), require('ethers'), require('web3')) :
  typeof define === 'function' && define.amd ? define(['exports', 'blockies', 'ethers', 'web3'], factory) :
  (global = global || self, factory(global.Vuetensils = {}, global.blockies, global.ethers, global.Web3));
}(this, function (exports, blockies, ethers, Web3) { 'use strict';

  blockies = blockies && blockies.hasOwnProperty('default') ? blockies['default'] : blockies;
  ...
  exports.VthBlockie = Blockie;
  exports.VthContract = Contract;
  exports.VthStatus = Status;
  exports.VthTx = Tx;
